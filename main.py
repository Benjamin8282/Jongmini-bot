...
from commands.character_commission import character_commission, character_scene_commission
...
class JongminiBot(commands.Bot):
    ...
    async def setup_hook(self):
        ...
        if COMMISSION_ENABLED:
            ...
            self.tree.add_command(character_scene_commission)
            logger.info("자캐 AI 커미션 커맨드 2종 등록됨 (BEDROCK_COMMISSION_ENABLED=true)")
        else:
